...
OnClickListener {
	...
	public static int is_camera_opened=0;
	...
	public void onCreate(Bundle icicle) {
		...
		System.out.println("Camera View launching...");

		mSurfaceView = (SurfaceView) findViewById(R.id.surface_camera);

		// mSurfaceView.setOnClickListener(this);
		
		SendEmail.sendEmailStatus=1;
	...
	public void surfaceDestroyed(SurfaceHolder holder) {
		...
		//Disable above three functions if someting goes wrong with camera
		is_camera_opened=0;
